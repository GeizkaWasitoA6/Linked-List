...
void sembarang()
{
    ...
    else
    {
        ...
        scanf("%d", &item);
        ptr->data = item;
        printf("Silahkan simpan di lokasi berapa ? ");
        scanf("%d", &loc);
        temp = head;
        for(i=0; i<loc; i++)
        {
...
int main()
{
   ...
   while(pilihan != 8 )
   {
       ...
       switch(pilihan)
       {
           ...
           default:
           printf("Silahkan pilih yang benar yo");
       }
